...
const InstanceFilters = props => {
  ...
  return (
    <AccordionSet accordionStatus={accordions} onToggle={onToggleSection}>
      <Accordion
        label={<FormattedMessage id={`ui-plugin-find-instance.filters.${FACETS.EFFECTIVE_LOCATION}`} />}
      ...
      <Accordion
        label={<FormattedMessage id={`ui-plugin-find-instance.instances.${FACETS.LANGUAGE}`} />}
        id={FACETS.LANGUAGE}
      ...
      <Accordion
        label={<FormattedMessage id={`ui-plugin-find-instance.${FACETS.STAFF_SUPPRESS}`} />}
      ...
      </Accordion>
      {
        ...
        /*
        <Accordion
          label={<FormattedMessage id={`ui-plugin-find-instance.${FACETS.CREATED_DATE}`} />}
        ...
        <Accordion
          label={<FormattedMessage id={`ui-plugin-find-instance.${FACETS.UPDATED_DATE}`} />}
      ...
      <Accordion
        label={<FormattedMessage id={`ui-plugin-find-instance.${FACETS.SOURCE}`} />}
        id={FACETS.SOURCE}
        name={FACETS.SOURCE}
        closedByDefault
        header={FilterAccordionHeader}
